...
if [ "$1" == "base" ] ; then
    ...
    sudo docker tag canal/canal-server:latest registry.cn-hangzhou.aliyuncs.com/rainbow954/canal-server:v1.1.4
    sudo docker push registry.cn-hangzhou.aliyuncs.com/rainbow954/canal-server:v1.1.4
